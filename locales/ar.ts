export const ar = {
    ...
    profile: {
        ...
        bio_short_1: "مع أكثر من 10 سنوات من الخبرة في الطب العام وإعادة التأهيل، كرّس د. رمدون حياته المهنية لتحسين نتائج المرضى من خلال الكشف المبكر، والتقييم الدقيق، وتطوير خطط رعاية شخصية مصممة خصيصاً لكل حالة فردية.",
        bio_short_2: "يعمل حالياً كمستشار زائر في نخبة من المستشفيات الدولية، ويقود عيادته برؤية تتمحور حول الدمج بين الرحمة الإنسانية وأحدث التقنيات الطبية في إعادة التأهيل العصبي والعظمي.",
