    ...
    <SectionWrapper id="contact" bg="light">
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-medical-primary p-10 md:p-16 text-white flex flex-col justify-between relative overflow-hidden">
          ...
          <div>
            <h3 className="text-3xl md:text-4xl font-bold font-heading mb-8">Contact Me</h3>
            ...
            <div className="space-y-10">
              <div className="flex items-start space-x-5">
                ...
                <div>
                  <h4 className="font-bold text-xl md:text-2xl mb-1">Email</h4>
               ...
               <div className="flex items-start space-x-5">
                 ...
                 <div>
                   <h4 className="font-bold text-xl md:text-2xl mb-1">Online Consultation Hours</h4>
        ...
        <div className="p-10 md:p-16 flex flex-col justify-center">
          <h3 className="text-3xl font-bold font-heading text-medical-primary mb-3">Instant Connection</h3>
