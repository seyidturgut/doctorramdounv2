  ...
  return (
    <SectionWrapper id="process" bg="white" className="relative overflow-hidden">
          ...
          {t.process.steps.map((step, index) => (
            ...
            >
              ...
              <div className="absolute -top-4 bg-medical-primary text-white font-bold text-sm px-3 py-1 rounded-full shadow-md z-20">
                {t.process.step_label} 0{index + 1}
              </div>

              {/* Icon */}
              <div className={`w-20 h-20 md:w-24 md:h-24 rounded-full ${stepsMetadata[index].color} flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300 relative z-10`}>
      ...
      <div className="mt-16 md:mt-24 text-center">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-medical-primary mb-4">{t.process.cta_title}</h3>
